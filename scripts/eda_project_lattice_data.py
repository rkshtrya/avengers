...
def write_markdown(summaries: list[dict]) -> None:
    ...
    lines.append("")
    lines.append("1. **San Ramon inside Contra Costa is feasible for the graph base.** San Ramon is a city inside Contra Costa County, and the county publishes parcel, zoning, land-use, city-limit, and urban-limit-line shapefiles that we can filter to the city.")
    ...
    lines.append("2. Read Contra Costa countywide parcels and city limits, filter parcels to San Ramon, and compute parcel count plus address/APN completeness.")
